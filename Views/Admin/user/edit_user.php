...
<head>
    ...
    <link rel="stylesheet" href="/project/Public/Css/Admin/adduser.css">
                        ...
                        <div class="row">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb d-flex h-100 align-items-center">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Chỉnh sửa thành viên</li>
                                </ol>
                            </nav>
                        </div>

                        <div class="row">
                            <h1 class="page-header">CHỈNH SỬA THÔNG TIN THÀNH VIÊN</h1>
                        </div>
                                ...
                                <div class="page-user">
                                    <div class="page-table">
                                        ...
                                        <form role="form" method="post"
                                            action="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=update&user_id=<?= $item['user_id'] ?>">
                                            <div class="form-group">
                                                <label>Họ & Tên</label>
                                                <input name="user_name" required class="form-control"
                                            ...
                                            <button type="reset" class="btn btn-default"><a href="">Trở lại</a></button>
                                        </form>
                                    </div>
                                    <?php
                                            }
