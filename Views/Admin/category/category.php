        ...
        <div class="main">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <h1 class="page-header">DANH MỤC SẢN PHẨM HIỆN CÓ</h1>
                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="button" class="btn btn-info"><a
                                                                href="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=edit&cat_id=<?= $item['cat_id'] ?>">Sửa</a></button>
                                                        <button type="button" class="btn btn-danger"><a
                                                                href="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=destroy&cat_id=<?= $item['cat_id'] ?>">Xóa</a></button>
                                                    </td>
                                                </tr>
                                                <?php
                                                    }
