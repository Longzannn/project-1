...
<head>
    ...
    <link rel="stylesheet" href="Public/Css/Admin/addcategory.css">
        ...
        <div class="main">
            ...
            <div class="page-wrapper">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <h1 class="page-header">CHỈNH SỬA DANH MỤC SẢN PHẨM</h1>
                    </div>
                        ...
                        <div class="col-lg-8">
                            <div class="page-user">
                                ...
                                <?php 
                                    ...
                                    <form role="form" method="post" action="?controller=<?= $controller ?>&redirect=<?= $redirect ?>&action=update&cat_id=<?= $item['cat_id'] ?>">
                                        <div class="form-group">
                                            <label>Tên danh mục:</label>
                                            <input type="text" name="cat_name"
                                                value="<?= $item['cat_name'] ?>" class="form-control"
